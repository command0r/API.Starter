...
dotnet ef migrations add $commitMessage --project .././Data/Migrations/ --context ApplicationDbContext -o Migrations/Application
dotnet ef migrations add $commitMessage --project .././Data/Migrations/ --context TenantDbContext -o Migrations/Tenant
